...
ALTER TABLE conversations
    ADD COLUMN IF NOT EXISTS notes TEXT NULL AFTER tags_json;
...
ALTER TABLE chatbot_knowledge_base
    ADD COLUMN IF NOT EXISTS source_type ENUM('manual','file') NOT NULL DEFAULT 'manual',
    ADD COLUMN IF NOT EXISTS file_name VARCHAR(255) NULL,
    ADD COLUMN IF NOT EXISTS file_path VARCHAR(500) NULL,
    ADD COLUMN IF NOT EXISTS file_mime_type VARCHAR(120) NULL,
...
ALTER TABLE chatbot_nodes
    ...
    ADD COLUMN IF NOT EXISTS options_json JSON NULL AFTER message,
    ADD COLUMN IF NOT EXISTS department_id BIGINT UNSIGNED NULL AFTER options_json,
    ADD COLUMN IF NOT EXISTS settings_json JSON NULL AFTER position_y;

ALTER TABLE chatbot_edges
    ADD COLUMN IF NOT EXISTS source_node_id BIGINT UNSIGNED NULL AFTER target_node_key,
    ADD COLUMN IF NOT EXISTS target_node_id BIGINT UNSIGNED NULL AFTER source_node_id,
    ADD COLUMN IF NOT EXISTS option_value VARCHAR(190) NULL AFTER condition_json;

ALTER TABLE chatbot_sessions
    ADD COLUMN IF NOT EXISTS current_node_id BIGINT UNSIGNED NULL AFTER current_node_key,
    ADD COLUMN IF NOT EXISTS selected_department_id BIGINT UNSIGNED NULL AFTER current_node_id,
    ADD COLUMN IF NOT EXISTS bot_paused TINYINT(1) NOT NULL DEFAULT 0 AFTER selected_department_id,
    ADD COLUMN IF NOT EXISTS collected_data JSON NULL AFTER context_json;
