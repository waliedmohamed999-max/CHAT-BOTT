...
$assetVersion = '20260519-premium-brand-v31';
$nav = [
...
كيف يمكننا مساعدتك اليوم؟</textarea></label>
                    <label class="inspector-field"><span>أزرار الرد</span><textarea id="nodeButtonsInput">المبيعات
الدعم الفني
الطلبات والشحن
الحسابات والفواتير
الشكاوى
التحدث مع موظف</textarea></label>
                    <label class="inspector-field"><span>القسم المرتبط</span><select id="nodeDepartmentInput"><option>المبيعات</option><option>الدعم الفني</option><option>الطلبات والشحن</option><option>الحسابات والفواتير</option><option>الشكاوى</option></select></label>
                    <label class="inspector-field"><span>Tag تلقائي</span><input id="nodeTagInput" value="department_selected"></label>
